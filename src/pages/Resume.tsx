...
export default function Resume() {
  ...
  // Use local data if available, otherwise fallback to database active resume
  const data = (localData || activeResume?.extracted_data) as ExtractedResumeData;
    ...
    <div className="min-h-screen pt-24 pb-20">
      <SectionContainer>
        <div className="max-w-4xl mx-auto bg-card/50 backdrop-blur-sm border border-border/50 shadow-xl rounded-lg p-8 md:p-12">
          ...
          {/* Header */}
          <header className="text-center mb-8 border-b border-border/30 pb-6">
            <h1 className="text-3xl md:text-4xl font-bold mb-3">{data?.contact?.name || "Resume"}</h1>
            ...
            <Button onClick={downloadResume} variant="outline" size="sm" className="gap-2">
